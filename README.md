...
### [2. Ex2](https://gitlab.eduxiji.net/T202419359994461/project2608132-275359/-/tree/ex2) (任务spawning与调度)
...
## 四、测试实验
1. 克隆项目，并切换到相应分支(例如切换到 ex1 分支: **git checkout ex1**)
2. cd 到实验文件夹内(包含src文件夹的那个文件夹，不要跑错地方了哦)
3. 执行 **cargo run**
4. 将在 qemu 中显示实验结果

[注] 如果运行时报错缺少的组件，请按照提示进行安装(应该不会出错吧😥)
