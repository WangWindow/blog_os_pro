...
const EFS_MAGIC: u32 = 0x00114514; // 魔数 0x00114514，用于文件系统合法性验证
const INODE_DIRECT_COUNT: usize = 28; // 直接块数
const NAME_LENGTH_LIMIT: usize = 27; // 文件名长度限制
const INODE_INDIRECT1_COUNT: usize = BLOCK_SIZE / 4; // 一级间接块数
const INODE_INDIRECT2_COUNT: usize = INODE_INDIRECT1_COUNT * INODE_INDIRECT1_COUNT; // 二级间接块数
const DIRECT_BOUND: usize = INODE_DIRECT_COUNT; // 直接块边界
const INDIRECT1_BOUND: usize = DIRECT_BOUND + INODE_INDIRECT1_COUNT; // 一级间接块边界
const INDIRECT2_BOUND: usize = INDIRECT1_BOUND + INODE_INDIRECT2_COUNT;
pub const DIRENT_SIZE: usize = 32; // 目录项大小
...
pub struct SuperBlock {
    ...
    pub inode_bitmap_blocks: u32, // inode位图块数
    pub inode_area_blocks: u32,   // inode区块数
    pub data_bitmap_blocks: u32,  // 数据位图块数
...
pub struct DiskInode {
    pub size: u32,                         // 磁盘 inode 的大小
    pub direct: [u32; INODE_DIRECT_COUNT], // 直接块
    pub indirect1: u32,                    // 一级间接块
    pub indirect2: u32,                    // 二级间接块
    type_: DiskInodeType,                  // 文件类型
}
