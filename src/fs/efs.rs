...
pub struct EasyFileSystem {
    ...
    pub inode_bitmap: Bitmap,               // inode 位图
    pub data_bitmap: Bitmap,                // 数据块位图
    inode_area_start_block: u32,            // inode 起始块号
    data_area_start_block: u32,             // 数据块起始块号
}
